                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if names[c] == 'Motorcycle' and m == 0:
                            ...
                            if y < gridy1:
                                ...
                                annotator.box_label(xyxy, label, color=colors(c, True)) 
                        # if m == 0:
                        #     cv2.imwrite('sj_np.jpg', im0)
                        #     signal = detectSJ('sj_np.jpg')
                        #     if signal == 'red':
                        #         print('signal jumping')
                        #         print('detecting licence plate')
                        #         np = 0

                        #     parking = detectNP('sj_np.jpg')
                        #     print(parking)
                        #     if parking == 'no parking' or parking == 'No Parking' or parking == 'NO PARKING':
                        ...
                        if names[c]=='NumberPlate' and np == 0:
                            label = None if hide_labels else (names[c] if hide_conf else f'{names[c]} {conf:.2f}')
                            annotator.box_label(xyxy, label, color=colors(c, True))
                            cv2.imwrite('numberplate.jpg', im0[int(xyxy[0]):int(xyxy[2]), int(xyxy[1]):int(xyxy[3])])
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='https://youtu.be/wqctLW0Hb_0', help='file/dir/URL/glob, 0 for webcam')
